...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "ApiSecretAuth": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = emitfy.generated.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.emitfy.com/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("emitfy.generated")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'ApiSecretAuth' in self.api_key:
            auth['ApiSecretAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Api-Secret',
